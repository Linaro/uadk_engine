...
int async_setup_async_event_notification_v1(int jobStatus)
{
	(void)jobStatus;
	ASYNC_JOB *job;
...
int async_clear_async_event_notification_v1(void)
{
	ASYNC_JOB *job;
	ASYNC_WAIT_CTX *waitctx;
	OSSL_ASYNC_FD efd;
...
int async_pause_job_v1(volatile ASYNC_JOB *job, int jobStatus)
{
	(void)jobStatus;
...
int async_wake_job_v1(volatile ASYNC_JOB *job, int jobStatus)
{
	(void)jobStatus;
